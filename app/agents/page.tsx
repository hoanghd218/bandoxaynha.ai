        ...
        <div className="min-h-screen flex flex-col bg-brand-gray-light">
            ...
            <main className="flex-1 w-full max-w-6xl mx-auto p-4 md:p-8">
                <div className="text-center mb-12 mt-8">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-brand-blue font-display mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {agents.map((agent, index) => (
                        ...
                        >
                            <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${agent.gradient} opacity-10 rounded-bl-full transform group-hover:scale-110 transition-transform duration-500`}></div>

                            <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${agent.gradient} flex items-center justify-center text-white mb-6 shadow-md group-hover:shadow-lg transition-shadow`}>
                                {agent.icon}
                            </div>
                            ...
                            {agent.href ? (
                                <Link href={agent.href} className="flex items-center font-semibold text-sm text-brand-blue group-hover:text-primary transition-colors">
                                    Khám phá ngay
